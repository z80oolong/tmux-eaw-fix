...
## 2026/08/22 現在の ChangeLog

2026/08/22 現在の [github 上の tmux の HEAD の commit である c1f947a3][TMRP] に対応した差分ファイルである ```tmux-HEAD-c1f947a3-fix.diff``` を追加致しました。
また、新しい安定版である [tmux 3.7c][TMXR] に対応した差分ファイルである ```tmux-3.7c-fix.diff``` も同時に追加しました。
...
## 2026/06/30 現在の ChangeLog

2026/06/30 現在の [github 上の tmux の HEAD の commit である 543d104f][TMRP] に対応した差分ファイルである ```tmux-HEAD-543d104f-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.7][TMXR] に対応した差分ファイルである ```tmux-3.7-fix.diff``` も同時に追加しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2026/05/21 現在の ChangeLog

2026/05/21 現在の [github 上の tmux の HEAD の commit である 8c51c0fd][TMRP] に対応した差分ファイルである ```tmux-HEAD-8c51c0fd-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.6b][TMXR] に対応した差分ファイルである ```tmux-3.6b-fix.diff``` も同時に追加しました。
...
## 2026/03/15 現在の ChangeLog

2026/03/15 現在の [github 上の tmux の HEAD の commit である bef4865d][TMRP] に対応した差分ファイルである ```tmux-HEAD-bef4865d-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2026/02/22 現在の ChangeLog

2026/02/22 現在の [github 上の tmux の HEAD の commit である 8356578a][TMRP] に対応した差分ファイルである ```tmux-HEAD-8356578a-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2026/02/12 現在の ChangeLog

2026/02/12 現在の [github 上の tmux の HEAD の commit である 615c27c1][TMRP] に対応した差分ファイルである ```tmux-HEAD-615c27c1-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2026/01/18 現在の ChangeLog

2026/01/18 現在の [github 上の tmux の HEAD の commit である 95b4bb51][TMRP] に対応した差分ファイルである ```tmux-HEAD-95b4bb51-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/12/15 現在の ChangeLog

2025/12/15 現在の [github 上の tmux の HEAD の commit である 4b810ae4][TMRP] に対応した差分ファイルである ```tmux-HEAD-4b810ae4-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.6a][TMXR] に対応した差分ファイルである ```tmux-3.6a-fix.diff``` も同時に追加しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/11/27 現在の ChangeLog

2025/11/27 現在の [github 上の tmux の HEAD の commit である 3542bfa5][TMRP] に対応した差分ファイルである ```tmux-HEAD-3542bfa5-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.6][TMXR] に対応した差分ファイルである ```tmux-3.6-fix.diff``` も同時に追加しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/11/13 現在の ChangeLog

2025/11/13 現在の [github 上の tmux の HEAD の commit である 768042d2][TMRP] に対応した差分ファイルである ```tmux-HEAD-768042d2-fix.diff``` を追加致しました。

本差分では、 SIXEL 関連のコードの bug fix に対応しています。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/11/03 現在の ChangeLog

2025/11/03 現在の [github 上の tmux の HEAD の commit である be2d4aa4][TMRP] に対応した差分ファイルである ```tmux-HEAD-be2d4aa4-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/10/19 現在の ChangeLog

2025/10/19 現在の [github 上の tmux の HEAD の commit である 449f255f][TMRP] に対応した差分ファイルである ```tmux-HEAD-449f255f-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/09/17 現在の ChangeLog

2025/08/03 現在の [github 上の tmux の HEAD の commit である 3e28777e][TMRP] に対応した差分ファイルである ```tmux-HEAD-3e28777e-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/08/03 現在の ChangeLog

2025/08/03 現在の [github 上の tmux の HEAD の commit である 6f9bcb7f][TMRP] に対応した差分ファイルである ```tmux-HEAD-6f9bcb7f-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/07/06 現在の ChangeLog

随分と更新が遅れまして誠に恐れ入ります。

2025/07/06 現在の [github 上の tmux の HEAD の commit である 7e439539][TMRP] に対応した差分ファイルである ```tmux-HEAD-7e439539-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/04/27 現在の ChangeLog

2025/04/27 現在の [github 上の tmux の HEAD の commit である 36fba4cc][TMRP] に対応した差分ファイルである ```tmux-HEAD-36fba4cc-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/03/14 現在の ChangeLog

2025/03/14 現在の [github 上の tmux の HEAD の commit である d4b8635f][TMRP] に対応した差分ファイルである ```tmux-HEAD-d4b8635f-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/02/20 現在の ChangeLog

2025/02/20 現在の [github 上の tmux の HEAD の commit である 9a377485][TMRP] に対応した差分ファイルである ```tmux-HEAD-9a377485-fix.diff``` を追加致しました。

これに伴い、tmux の HEAD の commit に対応した差分ファイルのうち古い差分ファイルをディレクトリ ```obsolete/``` に移動しました。どうか御了承下さい。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2025/01/09 現在の ChangeLog

2025/01/09 現在の [github 上の tmux の HEAD の commit である 00894d18][TMRP] に対応した差分ファイルである ```tmux-HEAD-00894d18-fix.diff``` を追加致しました。
...
なお本差分ファイルにおいて、 [HEAD 版の tmux][TMRP] における SIXEL 関連のコードの大幅な変更に対応しております。
...
2024/09/29 現在の [github 上の tmux の HEAD の commit である 7c30056d][TMRP] に対応した差分ファイルである ```tmux-HEAD-7c30056d-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.5][TMXR] に対応した差分ファイルである ```tmux-3.5-fix.diff``` も同時に追加しました。
...
2024/08/25 現在の [github 上の tmux の HEAD の commit である 34807388][TMRP] に対応した差分ファイルである ```tmux-HEAD-34807388-fix.diff``` を追加致しました。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] と、野良差分ファイルを適用した [tmux][TMUX] をソースコードからビルドすること無く、ビルド済のバイナリファイルとして容易に導入することが出来る AppImage パッケージである [tmux-eaw-appimage][TAPP] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2024/07/21 現在の ChangeLog

前回更新より間が空いてしまい、誠に恐れ入ります。

2024/07/21 現在の [github 上の tmux の HEAD の commit である 3c2621b4][TMRP] に対応した差分ファイルである ```tmux-HEAD-3c2621b4-fix.diff``` を追加致しました。

また、野良差分ファイルを適用した [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] と、野良差分ファイルを適用した [tmux][TMUX] をソースコードからビルドすること無く、ビルド済のバイナリファイルとして容易に導入することが出来る AppImage パッケージである [tmux-eaw-appimage][TAPP] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2024/05/19 現在の ChangeLog

2024/05/19 現在の [github 上の tmux の HEAD の commit である 0903790b][TMRP] に対応した差分ファイルである ```tmux-HEAD-0903790b-fix.diff``` を追加致しました。
...
2024/05/01 現在の [github 上の tmux の HEAD の commit である 3823fa2c][TMRP] に対応した差分ファイルである ```tmux-HEAD-3823fa2c-fix.diff``` を追加致しました。
...
2024/03/26 現在の [github 上の tmux の HEAD の commit である 3c3643f5][TMRP] に対応した差分ファイルである ```tmux-HEAD-3c3643f5-fix.diff``` を追加致しました。

なおこの際、本家による SIXEL 対応機能に関する大幅なバグフィックスも同時に取り込んでおります。
...
2024/03/05 現在の [github 上の tmux の HEAD の commit である 608d1134][TMRP] に対応した差分ファイルである ```tmux-HEAD-608d1134-fix.diff``` を追加致しました。

また、新しい安定版である [tmux 3.4][TMXR] に対応した差分ファイルである ```tmux-3.4-fix.diff``` も同時に追加しました。
...
2021/03/24 現在の [github 上の tmux の HEAD の commit である be568ea3][TMRP] に対応した差分ファイルである ```tmux-HEAD-be568ea3-fix.diff``` を追加致しました。
...
2021/01/12 現在の [github 上の tmux の HEAD の commit である dc1e1125][TMRP] に対応した差分ファイルである ```tmux-HEAD-dc1e1125-fix.diff``` を追加致しました。
...
2020/11/06 現在の [github 上の tmux の HEAD の commit である dac285c9][TMRP] に対応した差分ファイルである ```tmux-HEAD-dac285c9-fix.diff``` を追加致しました。
...
2020/04/14 現在の [github 上の tmux の HEAD の commit である b117c3b8][TMRP] に対応した差分ファイルである ```tmux-HEAD-b117c3b8-fix.diff``` を追加致しました。
...
2020/02/04 現在の [github 上の tmux の HEAD の commit である c915cfc7][TMRP] に対応した差分ファイルである ```tmux-HEAD-c915cfc7-fix.diff``` を追加致しました。
...
これに伴い、差分ファイル ```tmux-2.7-fix.diff, tmux-HEAD-c9d482ab-fix.diff``` を削除しました。どうか御了承下さい。

また、 East Asian Ambiguous Character を全角文字の幅で表示する [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2019/01/16 現在の ChangeLog

2019/01/16 現在の [github 上の tmux の HEAD の commit である c9d482ab][TMRP] に対応した差分ファイルである ```tmux-HEAD-c9d482ab-fix.diff``` を追加致しました。

これに伴い、差分ファイル ```tmux-2.7-fix.diff, tmux-HEAD-1c5093c1-fix.diff``` を削除しました。どうか御了承下さい。

また、 East Asian Ambiguous Character を全角文字の幅で表示する [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2018/12/13 現在の ChangeLog
...
## 2018/11/06 現在の ChangeLog

ここ最近は各種諸用が重なり、本差分ファイルの更新が滞りましたことにつきまして、誠に恐れ入ります。

2018/11/06 現在の [github 上の tmux の HEAD の commit である b1ad075d][TMRP] に対応した差分ファイルである ```tmux-HEAD-b1ad075d-fix.diff``` を追加致しました。

これに伴い、差分ファイル ```tmux-HEAD-5a7cf897-fix.diff``` を削除しました。どうか御了承下さい。

また、 East Asian Ambiguous Character を全角文字の幅で表示する [tmux][TMUX] を導入するための Formula 群である [z80oolong/tmux][TAP1] も併せて更新しました。こちらの方もどうか御覧下さい。

## 2018/10/05 現在の ChangeLog
...
[TAPP]:https://github.com/z80oolong/tmux-eaw-appimage/releases
